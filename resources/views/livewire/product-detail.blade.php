  <div class="lg:col-span-2 space-y-4">
      ...
      <div class="flex gap-4 justify-start">
          ...
          <div class="grid grid-cols-12 gap-2">
              ...
              <button type="button" wire:click="addToChart({{ $product }})" class="p-2 bg-[#1f2937] text-white text-xs rounded-md w-full col-span-7 flex justify-center items-center">

                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" wire:loading.remove viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
              ...
              <button type="button" class="p-2 bg-gray-200 text-xs text-gray-800 rounded-md flex items-center col-span-5">
