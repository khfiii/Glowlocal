                ...
                <div class="lg:col-span-2 space-y-4">
                    ...
                    <div class="flex flex-col gap-3">
                        <button wire:loading.remove type="button" wire:click="addToChart({{ $product }})"
                            class="w-full  px-6 py-3 bg-[#1f2937] text-white text-sm font-semibold rounded-md">Masukan
                            Keranjang</button>

                        <button wire:loading wire:target="addToChart" disabled type="button"
                            class="py-2.5 px-5 me-2 text-sm font-medium text-gray-900 bg-gray-700 rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 inline-flex items-center">
