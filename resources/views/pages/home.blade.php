    ...
    <section class="text-gray-600 body-font pt-8 -mt-10 space-y-4">
        ...
        <div class="container flex justify-center">
            <div class="text-start md:text-center md:max-w-3xl">
                <h1 class="title-font sm:text-4xl text-xl mb-4 font-bold text-gray-900 font-serif text-start md:text-center">Dapatkan Ebooks dari google play books kurang dari 5000 Rupiah</span>
                </h1>
