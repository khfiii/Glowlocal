<x-app-layout>
    ...
    @push('meta')
        ...
        <meta name="keywords"
            content="glowlocal, produk digital, ebook terjemahan indonesia, ebook, twointomedia, ebook gratis bahasa indonesia">
        <meta property="og:title" content="Glowlocal Shop">
        <meta property="og:description"
            content="Jelajahi Beragam Koleksi Ebook Keren, dan Produk Digital 
                    lainnya
                    Khusus Untukmu ">
    @endpush
        ...
        <div class="container flex justify-center">
            <div class="text-start md:text-center md:max-w-3xl">
                ...
                <div class="flex flex-col md:flex-row gap-2 md:justify-center">
                    ...
                    @if (\Browser::isInApp())
                        <a href="#" class="relative inline-block px-4 py-2 font-medium group"
